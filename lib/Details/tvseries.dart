...
class tvdetails extends StatefulWidget {
  ...
  @override
  State<tvdetails> createState() => _TvSeriesDetailsState();
}

class _TvSeriesDetailsState extends State<tvdetails> {
                  ...
                  slivers: [
                    ...
                    SliverList(
                      ...
                      Container(
                          ...
                          child: Text(
                              tvdetails[0]['overview'].toString())),
                      Padding(
                        padding: const EdgeInsets.only(left: 20.0, top: 10),
                        child: Userreview(revdeatils: TvSeriesREview),
                      ),
                      Container(
                          padding: EdgeInsets.only(left: 10, top: 20),
                          child: Text("Status : " +
                              tvdetails[0]['status'].toString())),
                      //created by
                      Container(
                          padding: EdgeInsets.only(left: 10, top: 20),
                      ...
                      Container(
                          ...
                          child: Text("Release date : " +
                              tvdetails[0]['releasedate'].toString())),
